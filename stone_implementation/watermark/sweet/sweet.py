...
class SWEETConfig:
    ...
    def __init__(self, transformers_config: TransformersConfig, *args, **kwargs) -> None:
        ...
        self.entropy_threshold = kwargs.get('entropy_threshold')
    ...
    def __init__(self, transformers_config: TransformersConfig, *args, **kwargs) -> None:
        """
            ...
            Parameters:
                ...
                transformers_config (TransformersConfig): Configuration for the transformers model.
        """
        self.config = SWEETConfig(transformers_config, gamma = kwargs.get('gamma'), delta = kwargs.get('delta'), hash_key = kwargs.get('hash_key'), prefix_length = kwargs.get('prefix_length'), entropy_threshold = kwargs.get('entropy_threshold'), z_threshold = kwargs.get('z_threshold'))
