import math
"""
Description of calculate_CWEM function parameters:
- pass_k: pass@k score
...
"""
def calculate_CWEM(pass_k, AUROC, perplexity_H, perplexity_wm):
    try: 
...
def run_experiment():
    for dataset, baselines in datasets.items():
        ...
        for baseline, values in baselines.items():
            ...
            calculate_CWEM(values["pass_k"], values["AUROC"], values["perplexity_H"],values["perplexity_wm"])
        print()
